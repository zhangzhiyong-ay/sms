...
public class CommonCodeMessage implements CodeMessage {
    ...
    public static final String COMMON_TEMPLATE_ID_ILLEGAL = "COMMON_TEMPLATE_ID_ILLEGAL";
    public static final String COMMON_PHONE_NUMBER_ILLEGAL = "COMMON_PHONE_NUMBER_ILLEGAL";
    public static final String COMMON_SERVICE_ERROR = "COMMON_SERVICE_ERROR";
    public static final String COMMON_CLIENT_RESPONSE_PARSE_ERROR = "COMMON_CLIENT_RESPONSE_PARSE_ERROR";

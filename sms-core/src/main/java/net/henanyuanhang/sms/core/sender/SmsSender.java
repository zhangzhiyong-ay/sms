...
public interface SmsSender {
     ...
     * @return
     */
    SendResult send(String phoneNumber, String templateKey, Map<String, String> templateParams) throws SmsSendException;
     ...
     * @return
     */
    SendResult send(List<String> phoneNumbers, String templateKey, Map<String, String> templateParams) throws SmsSendException;
     ...
     * @return
     */
    SendResult send(List<String> phoneNumbers, List<String> templateKeys, List<Map<String, String>> templateParams) throws SmsSendException;
}
